...
@Component({
  ...
  template: `
    ...
    <div
      class="flex flex-col space-y-1 text-base w-56 absolute -z-10 transition-all ease-in-out duration-300 {{
        isUserInfoVisible ? 'right-0 opacity-100' : '-right-20 opacity-0'
      }} top-[83px] bg-mainGray shadow-userInfoShadow p-3 rounded-bl-lg">
