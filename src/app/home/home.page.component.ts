  ...
  template: ` <div class="flex flex-col w-full bg-mainGray pt-14">
    <div
      ...
      <div
        ...
        <div class="h-72 sm:h-80 w-72 sm:w-80 relative">
          <img
    ...
    <div
      ...
      <span
        ...
        great fun but also allows for data collection and strategy learning for
        artificial intelligence.
      </span>
    </div>
    <div
      class="flex flex-row justify-between mt-10 pl-8 md:pl-16 bg-darkGray pt-10 pb-6 md:py-10">
    ...
    <div class="flex w-full items-center justify-start bg-darkGray pb-10">
      <span
        class="flex w-full 2xs:w-[97%] xs:w-11/12 sm:w-4/5 md:w-2/3 lg:w-1/2 h-14 xs:h-20 items-center justify-center bg-mainOrange text-2xs 2xs:text-xs xs:text-sm sm:text-base lg:text-lg px-2 xs:px-4 sm:px-10 font-mono mt-0 2xs:mt-4 xs:mt-8 sm:mt-16">
